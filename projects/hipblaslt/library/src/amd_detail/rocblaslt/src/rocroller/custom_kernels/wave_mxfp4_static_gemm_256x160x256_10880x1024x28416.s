...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_256x160x256_10880x1024x28416
	.p2align	8
	.type	wave_mxfp4_static_gemm_256x160x256_10880x1024x28416,@function
wave_mxfp4_static_gemm_256x160x256_10880x1024x28416:
...
.LBB0_0:
	...
	v_mul_u32_u24_e32 v87, 0x3780, v2
	s_lshl_b32 s46, s2, 7
	...
	v_add_u32_e32 v1, 0xde000, v1
	s_mov_b32 m0, s47
	v_or_b32_e32 v5, 0x80, v2
	buffer_load_dwordx4 v1, s[28:31], 0 offen lds
	v_mul_u32_u24_e32 v1, 0x3780, v5
	s_movk_i32 s48, 0x2a80
	...
	v_mul_u32_u24_e32 v2, 0x3780, v5
	...
	s_mov_b32 s51, 0x939a85c5
	v_mul_hi_i32 v17, v13, s51
	v_add_u32_e32 v13, v17, v13
	v_lshrrev_b32_e32 v17, 31, v13
	v_ashrrev_i32_e32 v13, 11, v13
	...
	v_mul_i32_i24_e32 v16, 0xffffc880, v16
	v_lshlrev_b32_e32 v15, 7, v3
	s_movk_i32 s3, 0x3780
	...
	v_mul_i32_i24_e32 v22, 0x378, v22
	v_sub_u32_e32 v22, v21, v22
	v_add_u32_e32 v26, 0x378, v22
	...
	v_mul_i32_i24_e32 v28, 0xfffffc88, v38
...
.LBB0_2:
	...
	v_sub_u32_e32 v101, 0x400, v4
	v_sub_u32_e32 v4, 0, v17
	v_sub_u32_e32 v100, 0x400, v3
...
.LBB0_3:
	...
	v_add_u32_e32 v128, 0xde080, v128
	s_add_i32 m0, s9, s47
	s_nop 0
	...
	v_mul_hi_i32 v134, v132, s51
	v_add_u32_e32 v132, v134, v132
	v_lshrrev_b32_e32 v134, 31, v132
	v_ashrrev_i32_e32 v132, 9, v132
	...
	v_mul_i32_i24_e32 v141, 0xfffffc88, v134
	...
	v_mul_i32_i24_e32 v145, 0xfffffc88, v130
	...
	v_mul_hi_i32 v148, v147, s51
	v_add_u32_e32 v147, v148, v147
	...
	v_mul_i32_i24_e32 v150, 0xfffffc88, v147
	...
	v_mul_hi_i32 v135, v131, s51
	v_add_u32_e32 v131, v135, v131
	v_lshrrev_b32_e32 v135, 31, v131
	v_ashrrev_i32_e32 v131, 9, v131
	...
	v_cmp_gt_i32_e32 vcc, s35, v140
	s_nop 1
	v_cndmask_b32_e32 v133, v88, v133, vcc
	v_cmp_gt_i32_e32 vcc, s35, v144
	s_nop 1
	...
	s_barrier
.LBB0_6:
	v_add_u32_e32 v85, s15, v97
	v_add_u32_e32 v86, s15, v98
	s_barrier
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_256x160x256_10880x1024x28416
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_256x160x256_10880x1024x28416, .Lfunc_end0-wave_mxfp4_static_gemm_256x160x256_10880x1024x28416

	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.num_vgpr, 184
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.num_agpr, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.numbered_sgpr, 71
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.private_seg_size, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.uses_vcc, 1
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.has_recursion, 0
	.set wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_256x160x256_10880x1024x28416
    ...
    .sgpr_count:     77
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_256x160x256_10880x1024x28416.kd
