...
; llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx950 -mattr='-fma-mix-insts' -O3 <.optimized.ll> -o <out.rocmasm>
	...
	.text
	.globl	wave_mxfp4_static_gemm_256x192x256_43392x13056x1792
	.p2align	8
	.type	wave_mxfp4_static_gemm_256x192x256_43392x13056x1792,@function
wave_mxfp4_static_gemm_256x192x256_43392x13056x1792:
...
.LBB0_0:
	...
	v_bitop3_b32 v9, v2, 7, v96 bitop3:0x48
	v_lshlrev_b32_e32 v1, 4, v9
	v_mul_u32_u24_e32 v4, 0x380, v6
	s_and_b32 s3, s25, 0xffff
	s_lshl_b32 s35, s2, 7
	s_or_b32 s25, s3, 0x43800000
	s_mov_b32 s27, 0x27000
	s_mov_b32 s26, 0x7ffffffe
	v_or_b32_e32 v100, v4, v1
	s_mov_b32 m0, s35
	s_or_b32 s40, s35, 0x2000
	buffer_load_dwordx4 v100, s[24:27], 0 offen lds
	v_add_u32_e32 v4, 0xe000, v100
	s_mov_b32 m0, s40
	v_or_b32_e32 v7, 0x80, v6
	buffer_load_dwordx4 v4, s[24:27], 0 offen lds
	v_mul_u32_u24_e32 v4, 0x380, v7
	s_mov_b32 s41, 0xa980
	s_mov_b64 s[20:21], s[6:7]
	v_or_b32_e32 v8, v4, v1
	v_bfrev_b32_e32 v101, -2
	v_cmp_gt_u32_e64 s[6:7], s41, v7
	s_or_b32 s42, s35, 0x4000
	s_mov_b32 m0, s42
	v_cndmask_b32_e64 v7, v101, v8, s[6:7]
	buffer_load_dwordx4 v7, s[24:27], 0 offen lds
	v_or_b32_e32 v7, 0xc0, v6
	v_mul_u32_u24_e32 v6, 0x380, v7
	v_or_b32_e32 v8, v6, v1
	v_cmp_gt_u32_e64 s[2:3], s41, v7
	s_or_b32 s43, s35, 0x6000
	s_mov_b32 m0, s43
	v_cndmask_b32_e64 v7, v101, v8, s[2:3]
	v_bfe_u32 v10, v96, 3, 4
	buffer_load_dwordx4 v7, s[24:27], 0 offen lds
	v_or_b32_e32 v7, v1, v10
	v_mul_lo_u16_e32 v7, 0x93, v7
	v_lshrrev_b16_e32 v12, 13, v7
	s_mul_i32 s33, s17, 0xc0
	v_bitop3_b32 v7, v2, 48, v0 bitop3:0xc8
	v_lshrrev_b32_e32 v11, 7, v96
	v_or3_b32 v13, s33, v12, v7
	v_lshlrev_b32_e32 v7, 4, v2
	v_lshlrev_b32_e32 v8, 8, v11
	v_sub_u32_e32 v14, v7, v8
	v_mul_i32_i24_e32 v15, 0xfffffc80, v12
	v_lshlrev_b32_e32 v9, 8, v9
	s_movk_i32 s34, 0x380
	v_add3_u32 v14, v9, v14, v15
	s_and_b32 s12, s21, 0xffff
	s_or_b32 s21, s12, 0x43800000
	s_mov_b32 s22, s26
	s_mov_b32 s23, s27
	v_mad_u32_u24 v13, v13, s34, v14
	s_add_i32 m0, s35, 0x10000
	v_or_b32_e32 v15, s33, v0
	buffer_load_dwordx4 v13, s[20:23], 0 offen lds
	v_lshlrev_b32_e32 v13, 4, v11
	v_or3_b32 v12, v15, v13, v12
	v_mad_u32_u24 v12, v12, s34, v14
	v_add_u32_e32 v13, 0xe000, v12
	s_add_i32 m0, s40, 0x10000
	v_add_u32_e32 v12, 0x1c000, v12
	buffer_load_dwordx4 v13, s[20:23], 0 offen lds
	...
	v_mul_i32_i24_e32 v97, -16, v12
	v_add3_u32 v122, v13, v97, v96
	v_ashrrev_i32_e32 v13, 31, v122
	v_xor_b32_e32 v14, v13, v122
	s_mov_b32 s44, 0x92492493
	v_mul_hi_i32 v15, v14, s44
	...
	v_and_b32_e32 v13, 62, v96
	s_add_u32 s28, s4, s22
	v_mul_lo_u16_e32 v13, 37, v13
	...
	s_bitset1_b32 s5, 14
	v_and_b32_e32 v20, 0xc0, v96
	v_mul_i32_i24_e32 v16, 0xffffffc8, v13
	v_lshlrev_b32_e32 v13, 6, v98
	v_sub_u32_e32 v19, v14, v15
	s_and_b32 s4, s4, 0xffff
	s_lshl_b32 s5, s5, 16
	v_add_u32_e32 v18, v17, v20
	v_add3_u32 v16, v19, v13, v16
	s_or_b32 s29, s4, s5
	s_movk_i32 s4, 0x60
	v_add_u32_e32 v21, s16, v18
	v_mad_u64_u32 v[18:19], s[12:13], v18, s14, v[16:17]
	v_mad_u32_u24 v17, v3, s4, v17
	s_waitcnt lgkmcnt(0)
	...
	s_mov_b32 s45, 0xa960
	s_or_b32 s37, s4, s5
	v_mad_u64_u32 v[16:17], s[4:5], s18, v17, v[16:17]
	v_cndmask_b32_e32 v19, v101, v18, vcc
	v_lshl_add_u32 v18, s14, 5, v18
	v_cmp_gt_i32_e32 vcc, s45, v21
	s_lshl_b32 s4, s18, 5
	s_mov_b32 s30, s26
	s_mov_b32 s31, s27
	v_cndmask_b32_e32 v18, v101, v18, vcc
	s_mov_b32 s38, s26
	s_mov_b32 s39, s27
	v_add_u32_e32 v17, s4, v16
	buffer_load_dword v118, v19, s[28:31], 0 offen
	buffer_load_dword v117, v18, s[28:31], 0 offen
	v_add_u32_e32 v18, s4, v17
	buffer_load_dword v121, v16, s[36:39], 0 offen
	buffer_load_dword v120, v17, s[36:39], 0 offen
	buffer_load_dword v119, v18, s[36:39], 0 offen
	v_cmp_eq_u32_e64 s[4:5], 0, v3
	s_mov_b32 s9, 0
	s_movk_i32 s22, 0x80
	s_movk_i32 s46, 0xfc80
	s_mov_b32 s19, 0x10000
	v_readfirstlane_b32 s8, v20
	v_mul_u32_u24_e32 v99, 0x60, v3
...
.LBB0_2:
	...
	v_lshlrev_b32_e32 v18, 7, v96
	v_lshlrev_b32_e32 v12, 11, v12
	v_bitop3_b32 v17, v98, v96, 7 bitop3:0x78
	v_sub_u32_e32 v12, v18, v12
	v_bitop3_b32 v16, v98, v16, 4 bitop3:0x36
	v_lshl_add_u32 v5, v5, 13, v12
	v_lshlrev_b32_e32 v17, 4, v17
	v_lshlrev_b32_e32 v16, 4, v16
	v_or_b32_e32 v102, v5, v17
	v_or_b32_e32 v103, v16, v5
	...
	v_add_u32_e32 v107, 32, v5
	v_add_u32_e32 v5, v1, v10
	v_mul_lo_u32 v3, v3, s1
	s_movk_i32 s1, 0x3700
	v_mul_u32_u24_e32 v0, 0x3800, v0
	v_add_u32_e32 v110, 0x80, v5
	v_add_u32_e32 v111, 16, v5
	...
	v_mov_b32_e32 v52, 0
	v_or_b32_e32 v104, v12, v17
	v_or_b32_e32 v105, v16, v12
	s_or_b32 s15, s8, s16
	v_add_u32_e32 v106, 64, v99
	v_add_u32_e32 v108, 32, v99
	s_add_i32 s0, s8, 32
	v_sub_u32_e32 v109, -9, v122
	s_mul_i32 s17, s17, 0x2a000
	v_add_u32_e32 v112, 0x1c100, v3
	v_add_u32_e32 v113, 0xe100, v3
	v_add_u32_e32 v114, 0x100, v0
	v_add3_u32 v115, v6, v1, s22
	v_add3_u32 v116, v4, v1, s22
	s_mov_b32 s50, 0x8000
	s_mov_b32 s51, 0x16000
	s_mov_b32 s1, 0
	s_mov_b32 s47, 0x24924925
	s_mov_b32 s22, s26
	s_mov_b32 s23, s27
...
.LBB0_3:
	v_lshrrev_b32_e32 v124, 3, v111
	v_lshrrev_b32_e32 v123, 3, v110
	v_mul_hi_u32 v124, v124, s47
	s_mov_b32 s49, s9
	s_mov_b32 s9, s50
	s_mov_b32 s50, s19
	s_mov_b32 s19, s51
	v_mul_hi_u32 v123, v123, s47
	v_mul_lo_u32 v124, v124, s46
	v_add_u32_e32 v125, s1, v100
	v_add_u32_e32 v126, 0x80, v125
	s_add_i32 m0, s9, s35
	s_barrier
	buffer_load_dwordx4 v126, s[24:27], 0 offen lds
	v_add_u32_e32 v125, 0xe080, v125
	s_add_i32 m0, s9, s40
	s_nop 0
	buffer_load_dwordx4 v125, s[24:27], 0 offen lds
	v_add_u32_e32 v125, s1, v116
	v_cndmask_b32_e64 v125, v101, v125, s[6:7]
	s_add_i32 m0, s9, s42
	s_nop 0
	buffer_load_dwordx4 v125, s[24:27], 0 offen lds
	v_add_u32_e32 v125, s1, v115
	v_cndmask_b32_e64 v125, v101, v125, s[2:3]
	s_add_i32 m0, s9, s43
	s_nop 0
	buffer_load_dwordx4 v125, s[24:27], 0 offen lds
	v_mad_u64_u32 v[124:125], s[52:53], v123, s34, v[124:125]
	v_add3_u32 v123, v114, s17, v124
	s_add_i32 m0, s51, s35
	s_nop 0
	buffer_load_dwordx4 v123, s[20:23], 0 offen lds
	v_add3_u32 v123, v113, s17, v124
	s_add_i32 m0, s51, s40
	s_nop 0
	buffer_load_dwordx4 v123, s[20:23], 0 offen lds
	v_add3_u32 v123, v112, s17, v124
	s_add_i32 m0, s51, s42
	s_nop 0
	buffer_load_dwordx4 v123, s[20:23], 0 offen lds
	v_add_u32_e32 v128, 64, v122
	v_subrev_u32_e32 v123, 56, v109
	v_cmp_gt_i32_e32 vcc, s48, v122
	v_add_u32_e32 v126, 8, v122
	s_nop 0
	v_cndmask_b32_e32 v123, v128, v123, vcc
	v_mul_hi_i32 v124, v123, s44
	v_add_u32_e32 v123, v124, v123
	v_lshrrev_b32_e32 v124, 31, v123
	v_ashrrev_i32_e32 v123, 3, v123
	...
	v_cndmask_b32_e32 v122, v126, v109, vcc
	v_mul_hi_i32 v126, v122, s44
	...
	v_mul_lo_u32 v122, v122, 56
	v_add_u32_e32 v126, s0, v124
	v_add_u32_e32 v123, s15, v124
	v_sub_u32_e32 v125, v125, v122
	v_mul_lo_u32 v126, s14, v126
	v_add_u32_e32 v125, v107, v125
	v_cmp_gt_i32_e32 vcc, s41, v123
	v_sub_u32_e32 v126, v126, v122
	v_add_u32_e32 v126, v107, v126
	v_cndmask_b32_e32 v125, v101, v125, vcc
	v_cmp_gt_i32_e32 vcc, s45, v123
	s_nop 1
	v_cndmask_b32_e32 v123, v101, v126, vcc
	...
	v_add_u32_e32 v124, v106, v124
	v_sub_u32_e32 v125, v125, v122
	v_mul_lo_u32 v126, s18, v126
	v_mul_lo_u32 v124, s18, v124
	v_add_u32_e32 v125, v125, v107
	v_sub_u32_e32 v126, v126, v122
	v_sub_u32_e32 v122, v124, v122
	v_add_u32_e32 v129, v126, v107
	v_add_u32_e32 v122, v122, v107
	...
	s_setprio 0
	s_barrier
	v_add_u32_e32 v122, s49, v103
	ds_read_b128 v[130:133], v122
	ds_read_b128 v[134:137], v122 offset:2048
	ds_read_b128 v[138:141], v122 offset:4096
	ds_read_b128 v[142:145], v122 offset:6144
	v_add_u32_e32 v122, s50, v105
	ds_read_b128 v[146:149], v122
	ds_read_b128 v[150:153], v122 offset:2048
	ds_read_b128 v[154:157], v122 offset:4096
	ds_read_b128 v[158:161], v122 offset:6144
	...
	s_barrier
.LBB0_6:
	v_add_u32_e32 v100, s19, v104
	v_add_u32_e32 v101, s19, v105
	s_barrier
	...
	.p2align	6, 0x0
	.amdhsa_kernel wave_mxfp4_static_gemm_256x192x256_43392x13056x1792
	...
	.text
.Lfunc_end0:
	.size	wave_mxfp4_static_gemm_256x192x256_43392x13056x1792, .Lfunc_end0-wave_mxfp4_static_gemm_256x192x256_43392x13056x1792

	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.num_vgpr, 204
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.num_agpr, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.numbered_sgpr, 54
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.num_named_barrier, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.private_seg_size, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.uses_vcc, 1
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.uses_flat_scratch, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.has_dyn_sized_stack, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.has_recursion, 0
	.set wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.has_indirect_call, 0
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name:           wave_mxfp4_static_gemm_256x192x256_43392x13056x1792
    ...
    .sgpr_count:     60
    .sgpr_spill_count: 0
    .symbol:         wave_mxfp4_static_gemm_256x192x256_43392x13056x1792.kd
